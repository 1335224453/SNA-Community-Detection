...
G = igraph.Graph.Read_Edgelist('facebook.txt', directed = False)

print('Ground truth number of communities: 42')
...
for level, communities in enumerate(communities_multilevel):
    ...
    print("Communities Detected by multilevel algorithm with level = " + str(level) + ": ", max(members) + 1)
